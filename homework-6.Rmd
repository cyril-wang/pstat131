...
The best-performing random forest model has a roc_auc of 0.7195045.
...
I am running into an error stating Error: Model-specific variable importance scores are currently not available for this type of model, which I think is because we used importance = impurity instead of setting importance = TRUE like in the lab. 
...
It seems that, once again, our model was best at predicting  normal types. It is the worst at predicting grass, fire, and psychic types.
